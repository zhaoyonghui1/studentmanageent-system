<%@ Page Title="" Language="C#" MasterPageFile="~/m.master" AutoEventWireup="true" ValidateRequest="false"  CodeFile="Add.aspx.cs" Inherits="admin_Add" %>
...
<td class="tbright"><div style="display:inline;float:left;">
<asp:TextBox ID="txt_pwd" runat="server" width="200" valType="required" msg="<font color =red>*</font>必填">123456</asp:TextBox>
</div> 
 </td></tr>
